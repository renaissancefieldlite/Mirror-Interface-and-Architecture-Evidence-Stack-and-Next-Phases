...
| --- | --- | --- |
| `Nest 1` | smallest formal systems | linear algebra, symmetries, invariants, encoded circuit states, transformer math, and validation gates |
| `Nest 2` | constrained structured systems | elements, molecular families, `H2O`, graph / bond geometry, minerals, nutrition chemistry, contaminants, and materials |
...
- `Nest 2`
  ...
  The 2D-4 blind split mapper then tested held-out allostery prediction using
  structural pocket/path features only. It set the clean boundary for the next
  build: blind Mirror pocket/path mean Jaccard `0.017703`, degree `0.008222`,
  closeness `0.015044`, active-proximity `0.015651`, random `0.014310`,
  label-shuffle p `0.061876`, and `PASSer_Ensemble` `0.201357` on the same
  scored rows. That means structural pocket/path features carry directional
  signal over simple graph controls, while the 2D closeout now needs external
  pocket candidates or stronger ligand-informed features.
  The 2D-5 ligand-informed split then ran that stronger input branch in the
  ligand-bound application setting: held-out mean Jaccard `0.260713`, matching
  the direct ligand-contact candidate baseline, beating the same-row
  `PASSer_Ensemble` bar `0.201357`, and clearing random / shuffled controls
  with p `0.001996`.
  The 2D-6 recurrence / path pass then reran the ligand-informed branch under
  an alternate held-out split and separated pocket recovery from
  communication-path recovery. Pocket recurrence held at mean Jaccard
  `0.249009`, still above the same-row `PASSer_Ensemble` bar `0.201357` and
  graph / random / shuffled controls. The active-site to predicted-pocket path
  ...
  `0.595067` versus shuffled `0.554863`, bad-descendant flag fraction
  `0.733696` versus shuffled `0.532891`, high retained-burden fraction
  `0.842391`, low mineralization-quality fraction `0.842391`, and p
  `0.000200`.
...
- [Nest 2E PFAS Safety Logic Report](./artifacts/validation/nest2e_pfas_safety_logic/nest2e_pfas_safety_logic_report.md)
...
1. [Mirror Architecture Integrated White Paper](./docs/MIRROR_ARCHITECTURE_INTEGRATED_WHITE_PAPER_2026-04-24.md)
2. [Unified Mirror Proof Spine](./docs/UNIFIED_MIRROR_PROOF_SPINE_2026-04-24.md)
3. [Publication And Cross-Pollination Path](./docs/PUBLICATION_AND_CROSS_POLLINATION_PATH_2026-04-24.md)
4. [Universal Substrate Comparator Atlas](./docs/UNIVERSAL_SUBSTRATE_COMPARATOR_ATLAS_2026-04-24.md)
5. [Natural World Nesting Atlas](./docs/NATURAL_WORLD_NESTING_ATLAS_2026-04-24.md)
6. [Cosmic / Universal Nesting Atlas](./docs/COSMIC_UNIVERSAL_NESTING_ATLAS_2026-04-24.md)
7. [Auxiliary Mathematics Atlas](./docs/AUXILIARY_MATHEMATICS_ATLAS_2026-04-24.md)
8. [Lattice Model Node Companion](./tools/lattice_model_node_companion/README.md)
9. [Nest 1 Formal Systems Foundation](./docs/NEST1_FORMAL_SYSTEMS_FOUNDATION_2026-04-24.md)
10. [Nest 1 Expanded Formal Systems Completion](./docs/NEST1_EXPANDED_FORMAL_SYSTEMS_COMPLETION_2026-04-24.md)
11. [Nest 1 Deep Learning Reality Map](./docs/NEST1_DEEP_LEARNING_REALITY_MAP_2026-04-24.md)
12. [Nest 1 Validation Forks](./docs/NEST1_VALIDATION_FORKS_2026-04-24.md)
13. [SPEC-1 Phase 12B HRV Validation Report](./artifacts/validation/nest1_spec_phase12b_hrv/nest1_spec_phase12b_hrv_report.md)
14. [DE-1 Phase 12B HRV Dynamics Validation Report](./artifacts/validation/de1_hrv_dynamics/de1_hrv_dynamics_report.md)
15. [Nest 1 Control-Closeout Report](./artifacts/validation/nest1_control_closeout/nest1_control_closeout_report.md)
...
20. [TOP-1/2 Dense Trajectory Preregistration](./docs/TOP12_DENSE_TRAJECTORY_PREREGISTRATION_2026-04-26.md)
21. [Nest 1 Finalization Closeout Board](./docs/NEST1_FINALIZATION_CLOSEOUT_BOARD_2026-04-26.md)
22. [Phase 12B Biological Control-Closeout](./artifacts/validation/phase12b_biological_control_closeout/phase12b_biological_control_closeout_report.md)
23. [Phase 12B Large-Set Expansion Protocol](./docs/PHASE12B_LARGE_SET_EXPANSION_PROTOCOL_2026-04-25.md)
24. [GRAPH-1/2 Pathway Validation Fork Report](./artifacts/validation/graph12_pathway/graph12_pathway_report.md)
25. [CTRL-1 LSPS Transition Validation Fork Report](./artifacts/validation/ctrl1_lsps_transition/ctrl1_lsps_transition_report.md)
26. [GRAPH-2 Phase 5 Bridge Pilot Report](./artifacts/validation/graph2_phase5_bridge/graph12_pathway_report.md)
27. [GRAPH-2 Quantum Label Crosswalk](./docs/GRAPH2_QUANTUM_LABEL_CROSSWALK_2026-04-26.md)
28. [GRAPH-2 Quantum Label Crosswalk Report](./artifacts/validation/graph2_quantum_label_crosswalk/graph2_quantum_label_crosswalk_report.md)
29. [GRAPH-2A Dense Internal Pathway Preregistration](./docs/GRAPH2A_DENSE_INTERNAL_PATHWAY_PREREGISTRATION_2026-04-26.md)
30. [GRAPH-2A Dense Internal Pathway Report](./artifacts/validation/graph2a_dense_internal_pathway/graph2a_dense_internal_pathway_report.md)
31. [GAME-1 Adversarial Protocol](./docs/GAME1_ADVERSARIAL_PROTOCOL_2026-04-26.md)
32. [GAME-1 Adversarial Protocol Report](./artifacts/validation/game1_adversarial_protocol/game1_adversarial_protocol_report.md)
33. [GAME-1 V7 Condition Crosswalk](./docs/GAME1_V7_CONDITION_CROSSWALK_2026-04-26.md)
34. [GAME-1 V7 Condition Crosswalk Report](./artifacts/validation/game1_v7_condition_crosswalk/game1_v7_condition_crosswalk_report.md)
35. [GRAPH-2 Independent Label Expansion Protocol](./docs/GRAPH2_INDEPENDENT_LABEL_EXPANSION_PROTOCOL_2026-04-26.md)
36. [GRAPH-2 Independent Label Gate Report](./artifacts/validation/graph2_independent_label_gate/graph2_independent_label_gate_report.md)
37. [GAME-1 Real Trial Expansion Protocol](./docs/GAME1_REAL_TRIAL_EXPANSION_PROTOCOL_2026-04-26.md)
38. [GAME-1 Real Trial Gate Report](./artifacts/validation/game1_real_trial_gate/game1_real_trial_gate_report.md)
39. [Nest 1 To Nest 2 Reality Handoff](./docs/NEST1_TO_NEST2_REALITY_HANDOFF_2026-04-26.md)
...
50. [Nest 2D-4 Blind Pocket Split Mapper](./artifacts/validation/nest2d_allostery_blind_pocket_split_mapper/nest2d_allostery_blind_pocket_split_mapper_report.md)
51. [Nest 2D-5 Ligand-Informed Split Mapper](./artifacts/validation/nest2d_allostery_ligand_informed_split_mapper/nest2d_allostery_ligand_informed_split_mapper_report.md)
52. [Nest 2D-6 Allostery Recurrence / Path Mapper](./artifacts/validation/nest2d_allostery_recurrence_path_mapper/nest2d_allostery_recurrence_path_mapper_report.md)
53. [Nest 2E PFAS Pathway Report](./artifacts/validation/nest2e_pfas_pathway/nest2e_pfas_pathway_report.md)
54. [Nest 2E PFAS Safety Logic Report](./artifacts/validation/nest2e_pfas_safety_logic/nest2e_pfas_safety_logic_report.md)
55. [Nest 2F Materials Stability Report](./artifacts/validation/nest2f_materials_stability/nest2f_materials_stability_report.md)
56. [Nest 2G RDKit Stronger Baseline Report](./artifacts/validation/nest2g_rdkit_baseline_comparison/nest2g_rdkit_baseline_comparison_report.md)
57. [Crossover Precursor Prototype Lanes](./docs/CROSSOVER_PRECURSOR_PROTOTYPE_LANES_2026-04-24.md)
58. [Nest 2 Constrained Structured Systems Foundation](./docs/NEST2_CONSTRAINED_STRUCTURED_SYSTEMS_FOUNDATION_2026-04-24.md)
59. [Nest 2 Structured Matter Completion](./docs/NEST2_STRUCTURED_MATTER_COMPLETION_2026-04-24.md)
60. [Nest 2 Expanded Structured Matter Atlas](./docs/NEST2_EXPANDED_STRUCTURED_MATTER_ATLAS_2026-04-24.md)
61. [Terahertz Cellular Resonance Bridge](./docs/TERAHERTZ_CELLULAR_RESONANCE_BRIDGE_2026-04-24.md)
62. [Terahertz Chemical Remediation Bridge](./docs/TERAHERTZ_CHEMICAL_REMEDIATION_BRIDGE_2026-04-24.md)
63. [Mirror Interface & Architecture Evidence Stack and Next Phases](./docs/MIRROR_INTERFACE_AND_ARCHITECTURE_EVIDENCE_STACK_AND_NEXT_PHASES_2026-04-22.md)
64. [Latent Architecture Discovery Highlight](./docs/LATENT_ARCHITECTURE_DISCOVERY_HIGHLIGHT_2026-04-22.md)
65. [V7 Integrated 10-Model Summary Pack](./artifacts/v7/posters/v7_integrated_10_model_summary_pack/V7_INTEGRATED_10_MODEL_SUMMARY_PACK_2026-04-19.md)
66. [V8 Internal Bridge White Paper PDF](./artifacts/v8/residual_stream_bridge/white_paper/v8_internal_bridge_white_paper_2026-04-20.pdf)
67. [Phase 2 Variance Pack PDF](./artifacts/v8/phase2_variance_pack/v8_phase2_variance_pack_2026-04-21.pdf)
68. [Phase 3 Dimension/Band Pack PDF](./artifacts/v8/phase3_dimension_band/v8_phase3_dimension_band_pack_2026-04-21.pdf)
69. [Phase 4 Localization Pack PDF](./artifacts/v8/phase4_localization_pack/v8_phase4_localization_pack_2026-04-21.pdf)
70. [Phase 4 Localization Variance Pack PDF](./artifacts/v8/phase4_localization_variance_pack/v8_phase4_localization_variance_pack_2026-04-21.pdf)
71. [Phase 5 Internal Bridge Pack PDF](./artifacts/v8/phase5_internal_bridge/v8_phase5_internal_bridge_pack_2026-04-22.pdf)
72. [Phase 6 PennyLane Encoding Pack PDF](./artifacts/v8/phase6_pennylane_encoding/v8_phase6_pennylane_encoding_pack_2026-04-22.pdf)
73. [Phase 7 Qiskit Mirror Pack PDF](./artifacts/v8/phase7_qiskit_mirror/v8_phase7_qiskit_mirror_pack_2026-04-22.pdf)
74. [Phase 8 Bell-State Calibration Pack PDF](./artifacts/v8/phase8_bell_state_calibration/v8_phase8_bell_state_calibration_pack_2026-04-22.pdf)
75. [Phase 9 IBM Hardware Bridge Pack PDF](./artifacts/v8/phase9_ibm_hardware_bridge/v8_phase9_ibm_hardware_bridge_pack_2026-04-22.pdf)
76. [Phase 9B IBM Hardware Repeatability Pack PDF](./artifacts/v8/phase9b_ibm_hardware_repeat/v8_phase9b_ibm_hardware_repeat_pack_2026-04-22.pdf)
77. [Phase 9C PennyLane Remote Hardware Pack PDF](./artifacts/v8/phase9c_pennylane_remote_hardware/v8_phase9c_pennylane_remote_hardware_pack_2026-04-22.pdf)
78. [Phase 9D PennyLane Remote Repeatability Pack PDF](./artifacts/v8/phase9d_pennylane_remote_repeat/v8_phase9d_pennylane_remote_repeat_pack_2026-04-22.pdf)
79. [Phase 10 Semantic Contextuality Pack PDF](./artifacts/v8/phase10_semantic_contextuality/v8_phase10_semantic_contextuality_pack_2026-04-23.pdf)
80. [Next Phase Research Plan From Phase 10](./docs/NEXT_PHASE_RESEARCH_PLAN_FROM_PHASE10_2026-04-23.md)
81. [Phase 11 To Phase 13 Physical Bell Bridge](./docs/PHASE11_TO_PHASE13_PHYSICAL_BELL_BRIDGE_2026-04-23.md)
82. [Phase 12B Biological Adapter White Paper](./docs/PHASE12B_BIOLOGICAL_ADAPTER_WHITE_PAPER_2026-04-23.md)
83. [Phase 12B Biological Comparison Pack PDF](./artifacts/v8/phase12b_biological_comparison_pack/V8_PHASE12B_BIOLOGICAL_COMPARISON_PACK_2026-04-24.pdf)
84. [Nest 1 Real-Trace Foundation Report](./artifacts/validation/nest1_real_trace_foundation/nest1_real_trace_foundation_report.md)
85. [Nest 1 Real-Trace Foundation Pack PDF](./artifacts/validation/nest1_real_trace_foundation/nest1_real_trace_foundation_pack_2026-04-25.pdf)
...
8. [GRAPH-2 Independent Label Expansion Protocol](./docs/GRAPH2_INDEPENDENT_LABEL_EXPANSION_PROTOCOL_2026-04-26.md)
9. [GRAPH-2 Quantum Label Crosswalk](./docs/GRAPH2_QUANTUM_LABEL_CROSSWALK_2026-04-26.md)
10. [GRAPH-2A Dense Internal Pathway Report](./artifacts/validation/graph2a_dense_internal_pathway/graph2a_dense_internal_pathway_report.md)
11. [GAME-1 Real Trial Expansion Protocol](./docs/GAME1_REAL_TRIAL_EXPANSION_PROTOCOL_2026-04-26.md)
12. [GAME-1 V7 Condition Crosswalk](./docs/GAME1_V7_CONDITION_CROSSWALK_2026-04-26.md)
13. [Nest 1 To Nest 2 Reality Handoff](./docs/NEST1_TO_NEST2_REALITY_HANDOFF_2026-04-26.md)
